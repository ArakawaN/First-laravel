                            ...
                            <div class="flex flex-wrap -m-2">
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <br>
                                  <input type="radio" id="gender" value='0' name="gender" @if($contact->gender==0)checked @endif class=" bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 m-3 leading-8 transition-colors duration-200 ease-in-out">男性
                                  <input type="radio" id="gender" value='1' name="gender" @if($contact->gender==1)checked @endif  class=" bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 m-3 leading-8 transition-colors duration-200 ease-in-out">女性
